...
while ($rt=mysqli_fetch_array($qry)) {
	echo "<b>Address:</b> " . rt['shippingAddress'] ."<br />";
	echo "<b>City:</b> " . $rt['shippingCity'] ."<br />";
	echo "<b>State: </b>" . $rt['shippingState']. ",";
		...
		<tbody>
				<tr>
					<td>
						...
						<?php $qry=mysqli_query($con,"select * from users where id='".$_SESSION['id']."'");
while ($rt=mysqli_fetch_array($qry)) {
	echo "<b>Address:</b> " .$rt['billingAddress']."<br />";
	echo "<b>City: </b> " .$rt['billingCity']."<br />";
	echo "<b>State: </b> " .$rt['billingState']. " , ";
