...
<h3>Shopping Center</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Pakistans fastest growing online clothing and fashion store. We deliver with in 2 hours.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+92) 000000000000<br>(+92) 000000000000</p>
                </div>
            </li>
